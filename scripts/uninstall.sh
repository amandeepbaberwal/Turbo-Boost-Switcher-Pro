...
OLD_PLIST="/Library/LaunchDaemons/com.local.TurboBoostSwitcher.helper.plist"
OLD_BIN="/Library/PrivilegedHelperTools/com.local.TurboBoostSwitcher.helper"
