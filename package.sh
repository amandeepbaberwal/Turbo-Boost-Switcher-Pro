...
cp "$CLONE_DIR/Menu/LaunchAgent.plist" "$STAGE/MacTurboDisabler.app/Contents/Resources/"
...
cp "$CLONE_DIR/Menu/LaunchAgent.plist" "$PKGROOT/Applications/MacTurboDisabler.app/Contents/Resources/"
